      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 animate-fade-in">
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold mb-4 sm:mb-6 text-white leading-tight">
          ...
          <span className="relative group text-white cursor-pointer inline-block hover:text-gray-300 transition-colors duration-300">
            {name}
            {/* Popup card */}
            <div className="absolute left-1/2 -translate-x-1/2 mt-4 sm:mt-6 w-72 sm:w-80 bg-white text-black text-left rounded-lg shadow-2xl border border-gray-200 opacity-0 scale-90 group-hover:opacity-100 group-hover:scale-100 transition-all duration-500 pointer-events-none z-50">
              <div className="p-6">
        ...
        <p className="text-base sm:text-lg lg:text-xl text-gray-300 mb-8 sm:mb-12 leading-relaxed max-w-2xl mx-auto font-light px-4">
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center px-4">
          <a
            href="#about"
            className="group relative inline-flex items-center justify-center gap-2 bg-white text-black font-semibold px-6 sm:px-8 py-3 sm:py-4 rounded-md 
            shadow-xl hover:shadow-2xl border border-white
            transition-all duration-300 transform hover:scale-105 hover:-translate-y-1 w-full sm:w-auto text-center text-sm sm:text-base"
          >
          ...
          <a
            href="#contact"
            className="inline-flex items-center justify-center gap-2 bg-transparent text-white font-semibold px-6 sm:px-8 py-3 sm:py-4 rounded-md 
            border border-white/50 hover:border-white hover:bg-white/10
            transition-all duration-300 transform hover:scale-105 w-full sm:w-auto text-center text-sm sm:text-base"
          >
            Get In Touch
          </a>
        </div>
